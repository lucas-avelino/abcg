...
void Buildings::initializeGL(GLuint program, std::string assetsPath) {
  ...
  // Load model
  loadModelFromFile(assetsPath + "high_building.obj");
...
void Buildings::loadModelFromFile(std::string_view path) {
